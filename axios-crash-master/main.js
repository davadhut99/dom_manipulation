...
function errorHandling() {
  axios.get('https://jsonplaceholder.typicode.com/todoss',{
    ...
    //   return status < 500;   //Reject if only status is greater than or equal to 500
    // }
  })
    .then(res => showOutput(res))
    .catch(err => {
...
axios.interceptors.request.use(
  config => {
    ...
    at ${new Date().getTime()}`); return config;
  },
  error => {
...
// AXIOS INSTANCES
const axiosInstace = axios.create({ baseURL: 'https://jsonplaceholder.typicode.com' });
